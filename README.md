...
Bu uygulama başlatıldığında `MYLAUNCHER` adında bir klasör oluşturur. Klasör içine `data.json` isimli bir dosya açar bunun nedeni kısayol verilerini sağlamaktır.
